        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Stok Terpack</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Edit Stok Terpack</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('packed-stocks.update', $stock->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <select class="form-select @error('packaging_process_id') is-invalid @enderror" 
                                ...
                                @foreach($processes as $process)
                                    <option value="{{ $process->id }}" 
                                            {{ old('packaging_process_id', $stock->packaging_process_id) == $process->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lot_number') is-invalid @enderror" 
                                   id="lot_number" name="lot_number" value="{{ old('lot_number', $stock->lot_number) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Catatan tambahan">{{ old('notes', $stock->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted small">
                        Edit informasi stok terpack di samping.
                        Setiap kemasan berisi 5kg benih padi.
                    </p>
                    <hr>
                    <ul class="list-unstyled small mb-0">
                        <li class="mb-2">
                            <strong>No. Stock:</strong><br>
                            {{ $stock->stock_number }}
                        </li>
                        <li class="mb-2">
